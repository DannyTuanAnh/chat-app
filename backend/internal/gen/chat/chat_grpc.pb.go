...
func (c *chatServiceClient) CreatePrivateConversation(ctx context.Context, in *CreatePrivateConversationRequest, opts ...grpc.CallOption) (*CreatePrivateConversationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreatePrivateConversationResponse)
...
func (c *chatServiceClient) GetConversationMembers(ctx context.Context, in *GetConversationMembersRequest, opts ...grpc.CallOption) (*GetConversationMembersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetConversationMembersResponse)
	err := c.cc.Invoke(ctx, ChatService_GetConversationMembers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedChatServiceServer) CreatePrivateConversation(context.Context, *CreatePrivateConversationRequest) (*CreatePrivateConversationResponse, error) {
...
func _ChatService_CreatePrivateConversation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreatePrivateConversationRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).CreatePrivateConversation(ctx, req.(*CreatePrivateConversationRequest))
	}
...
func _ChatService_GetConversationMembers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetConversationMembersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).GetConversationMembers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_GetConversationMembers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).GetConversationMembers(ctx, req.(*GetConversationMembersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
